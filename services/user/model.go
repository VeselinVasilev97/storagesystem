...
type User struct {
	...
	Roles     []Role    `gorm:"many2many:storageuser.user_roles;joinForeignKey:UserID;joinReferences:RoleID" json:"roles,omitempty"`
}
...
type Role struct {
	...
	CreatedAt time.Time `gorm:"column:created_at" json:"created_at"`
	Users     []User    `gorm:"many2many:storageuser.user_roles;joinForeignKey:RoleID;joinReferences:UserID" json:"users,omitempty"`
}
...
func (Role) TableName() string {
	return "storageuser.roles"
}

func (UserRoles) TableName() string {
	return "storageuser.user_roles"
}
